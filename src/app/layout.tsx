...
import './globals.css';
export const metadata:Metadata={title:'Oonchai — Your story begins here',description:'Meet a character. Create a scenario. Become anyone. An original AI roleplay platform.',icons:{icon:'/favicon.svg'}};
