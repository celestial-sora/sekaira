...
import {characterArtwork,listCommunity,setCharacterVisibility,validateShareRecipients} from '../src/lib/community';
...
const character={id:'shared-character',owner_id:'owner',name:'Shared character',description:'',personality:'',greeting:'hello',world_id:null,scenario_id:null,avatar:'0',tags:[],published:false,visibility:'private',created_at:new Date().toISOString()};
